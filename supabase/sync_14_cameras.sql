...
SELECT 'CAM_09', 'Camera 9', 'rtsp://operator:smart1976@snap-dartford.dyndns.org:554/Streaming/Channels/901', 'hikvision', 'gym', 'online', organization_id FROM cameras WHERE camera_id = 'CAM_01' ON CONFLICT (camera_id) DO UPDATE SET rtsp_url = EXCLUDED.rtsp_url;

INSERT INTO cameras (camera_id, name, rtsp_url, camera_type, zone, status, organization_id)
SELECT 'CAM_10', 'Camera 10', 'rtsp://operator:smart1976@snap-dartford.dyndns.org:554/Streaming/Channels/1001', 'hikvision', 'gym', 'online', organization_id FROM cameras WHERE camera_id = 'CAM_01' ON CONFLICT (camera_id) DO UPDATE SET rtsp_url = EXCLUDED.rtsp_url;

INSERT INTO cameras (camera_id, name, rtsp_url, camera_type, zone, status, organization_id)
SELECT 'CAM_11', 'Camera 11', 'rtsp://operator:smart1976@snap-dartford.dyndns.org:554/Streaming/Channels/1101', 'hikvision', 'gym', 'online', organization_id FROM cameras WHERE camera_id = 'CAM_01' ON CONFLICT (camera_id) DO UPDATE SET rtsp_url = EXCLUDED.rtsp_url;

INSERT INTO cameras (camera_id, name, rtsp_url, camera_type, zone, status, organization_id)
SELECT 'CAM_12', 'Camera 12', 'rtsp://operator:smart1976@snap-dartford.dyndns.org:554/Streaming/Channels/1201', 'hikvision', 'gym', 'online', organization_id FROM cameras WHERE camera_id = 'CAM_01' ON CONFLICT (camera_id) DO UPDATE SET rtsp_url = EXCLUDED.rtsp_url;

INSERT INTO cameras (camera_id, name, rtsp_url, camera_type, zone, status, organization_id)
SELECT 'CAM_13', 'Camera 13', 'rtsp://operator:smart1976@snap-dartford.dyndns.org:554/Streaming/Channels/1301', 'hikvision', 'gym', 'online', organization_id FROM cameras WHERE camera_id = 'CAM_01' ON CONFLICT (camera_id) DO UPDATE SET rtsp_url = EXCLUDED.rtsp_url;

INSERT INTO cameras (camera_id, name, rtsp_url, camera_type, zone, status, organization_id)
SELECT 'CAM_14', 'Camera 14', 'rtsp://operator:smart1976@snap-dartford.dyndns.org:554/Streaming/Channels/1401', 'hikvision', 'gym', 'online', organization_id FROM cameras WHERE camera_id = 'CAM_01' ON CONFLICT (camera_id) DO UPDATE SET rtsp_url = EXCLUDED.rtsp_url;
